    ...
    <?php while ( have_posts() ) : the_post(); ?>
      <article id="post-<?php the_ID(); ?>" <?php post_class( 'card' ); ?>>
        <?php if ( has_post_thumbnail() ) : ?>
          <div class="thumb-wrap"><?php the_post_thumbnail( 'card-thumb', [ 'loading' => 'lazy', 'decoding' => 'async', 'sizes' => '(max-width:600px) 100vw, 50vw' ] ); ?></div>
        <?php endif; ?>
...
<?php else : ?>
  <p class="meta"><?php esc_html_e( 'No posts yet.', 'minimal-gstyle' ); ?></p>
<?php endif; ?>
